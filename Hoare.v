...
Proof. 
  ...
  inversion H; subst.
 (*  assert (t_update (t_update st X (aeval st a 1)) X (st X) = st).
...
Proof.
  ...
  rewrite t_update_neq. simpl. destruct H1. assumption.
...
Proof.
  ...
  rewrite t_update_neq. rewrite t_update_eq. simpl. assumption.
  ...
  rewrite t_update_neq. rewrite t_update_eq. simpl. simpl in H.
